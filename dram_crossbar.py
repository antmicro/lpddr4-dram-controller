...
from common import *
from dram_core import *

# DRAMCrossbar -------------------------------------------------------------------------------------

class DRAMCrossbar(Module):
    """Multiplexes DRAMController (slave) between ports (masters)
    ...
    Parameters
    ----------
    controller : DRAMInterface
        Interface to DRAMController
    ...
    def __init__(self, controller):
        ...
        if controller.settings.phy.read_latency:
    ...
    def do_finalize(self):
        ...
        for master in self.masters:
            ...
            if self.read_latency is None:
                self.comb += master.rdata.valid.eq(controller.rdata_valid)
